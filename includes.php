...
// Models
include_once ROOT . "models/assignments.php";
include_once ROOT . "models/applications.php";
...
include_once ROOT . "models/trainings.php";
include_once ROOT . "models/award.php";
include_once ROOT . "models/operations.php";
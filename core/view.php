...
class View {
    ...
    public function __construct($files, $footer = false, $data = null) {
        ...
        <html lang='en-GB'>
            <head>
                ...
                <link rel='stylesheet' href='".URL."css/style.min.css?v=".time()."' type='text/css' />
                ";
                if($this->css != null) {
            ...
            <body id='main-body' class='".(Application::$isDark ? 'theme--dark' : 'theme--light')."'>
                <main id='app-root'>
                            ...
                            if ($modals) {
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-content form">
                                            ...
                                            foreach($modals as $modal) {
                                                ...
                                                if ($fields && Form::canSubmitForm($modal)) {
                                                    ?>
                                ...
                                <script>
                                    ...
                                    function showModal(btn) {
                                        ...
                                        modalTitle.innerHTML = formName + " Form";
    ...
    public static function buildHistoryTable($logs, $type = "actioner") {
        include(ROOT . "views/history-table.php");
    }
